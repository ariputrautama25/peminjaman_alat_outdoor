  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <b><marquee style="font-size:25px;color:green;font-family:Times New Roman;padding-top:5px;"scrollamount="13">.: Selamat Datang di Halaman Sistem Peminjaman Alat Outdor :.</marquee></b>
          ...
          <div class="row">
            <div class="col-lg-6 col-xs-6">
              <div class="small-box bg-blue">
                ...
                <a href="<?php echo base_url('index.php/user/barang') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <div class="col-lg-6 col-xs-6">
             <div class="small-box bg-yellow">
                ...
                <a href="<?php echo base_url('index.php/user/riwayat') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
