            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode" placeholder="Nama Barang" value="<?php echo $brg->kode; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Sisa Stok</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="unit" placeholder="Peminjam" required>
                    </div>
                    <div class="form-group">
                        <label>No Telp</label>
